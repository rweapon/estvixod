import AdvantageCard from "@widgets/advantages/ui/AdvantageCard/AdvantageCard";
...
export default function Advantages() {
  return (
    <section className="bg-base-200 px-8 md:px-14 2xl:px-[100px] py-[84px] flex flex-col gap-10 xl:flex-row items-center justify-between">
      <div className="flex flex-col gap-6 md:gap-12 xl:max-w-[50%]">
